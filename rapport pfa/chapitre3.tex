...
\subsubsection{Perspectives (hors Sprint actuel)}

\begin{itemize}
  \item \textbf{Module de réclamations}~: à prévoir dans une évolution future.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|c|p{3.6cm}|p{7.2cm}|}
    ...
    \hline
    4 & Entretiens \& décisions & Meetings, workflow de statuts, historique \\
    \hline
    5 & Embauche \& pilotage & Confirmation embauche, admis, dashboards, exports \\
    \hline
  \end{tabular}
\end{table}
