// CI — Gateway
// Jenkins Script Path: devops/pipelines/ci-gateway.Jenkinsfile
...
pipeline {
        ...
        withSonarQubeEnv('SonarQube') {
          sh """
            docker run --rm --add-host=host.docker.internal:host-gateway \
              ...
              -Dsonar.projectKey=daam-gateway \
              -Dsonar.projectName=DAAM-gateway \
  ...
  post {
    success { echo 'CI OK — gateway' }
    failure { echo 'CI FAILED — gateway' }
  }
}
