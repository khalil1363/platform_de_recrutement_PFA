// CI — Reclamation
// Jenkins Script Path: devops/pipelines/ci-reclamation.Jenkinsfile
...
pipeline {
  ...
  environment {
    ...
    SERVICE_DIR = 'backend/microservices/reclamation'
  }
        ...
        withSonarQubeEnv('SonarQube') {
          sh """
            docker run --rm --add-host=host.docker.internal:host-gateway \
              ...
              -Dsonar.projectKey=daam-reclamation \
              -Dsonar.projectName=DAAM-reclamation \
  ...
  post {
    success { echo 'CI OK — reclamation' }
    failure { echo 'CI FAILED — reclamation' }
  }
}
