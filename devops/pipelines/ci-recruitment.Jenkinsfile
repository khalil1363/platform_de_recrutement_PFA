// CI — Recruitment (folder: backend/microservices/recretment)
// Jenkins Script Path: devops/pipelines/ci-recruitment.Jenkinsfile
...
pipeline {
  ...
  environment {
    ...
    SERVICE_DIR = 'backend/microservices/recretment'
  }
        ...
        withSonarQubeEnv('SonarQube') {
          sh """
            docker run --rm --add-host=host.docker.internal:host-gateway \
              ...
              -Dsonar.projectKey=daam-recruitment \
              -Dsonar.projectName=DAAM-recruitment \
  ...
  post {
    success { echo 'CI OK — recruitment' }
    failure { echo 'CI FAILED — recruitment' }
  }
}
