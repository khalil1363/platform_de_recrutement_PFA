...
@Component({
  selector: 'app-admin-hired',
  templateUrl: './admin-hired.component.html',
  styleUrl: './admin-hired.component.css'
})
export class AdminHiredComponent implements OnInit {
  loading = false;
  groups: RhHiredGroup[] = [];
  filterFirstName = '';
  filterLastName = '';
  ...
  private groupByRh(items: JobApplication[]): RhHiredGroup[] {
    const map = new Map<string, RhHiredGroup>();
